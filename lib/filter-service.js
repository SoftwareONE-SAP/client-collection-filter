...
FilterService.prototype._generateField = function(field, existingField) {
  ...
  if (!_.has(self._allowedTypes, obj.type) || !self._allowedTypes[obj.type]) {
    throw new Meteor.Error(
...
FilterService.prototype._processFieldData = function(field, existingField) {
  ...
  switch (field.type) {
    ...
    case 'date':
      ...
      break;
    default:
      if (!_.has(self._allowedTypes, field.type) || !self._allowedTypes[field.type]) {
        throw new Meteor.Error(
          'FilterService-field-type',
 ...
 */
FilterService.prototype.addFieldType = function(type) {
  var self = this;
