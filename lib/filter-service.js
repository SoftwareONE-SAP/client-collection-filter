...
FilterService.prototype._processFieldData = function(field) {
  ...
  switch (field.type) {
    case 'enum':
      ...
      /**
       * Check enum values and map their position in the array
       * @type {Object}
       */
      field.options._enumMap = field.options._enumMap || {};
      _.each(field.options._data, function(option, index) {
        ...
        /**
         * Map the option for faster finding
         */
        field.options._enumMap[String(option.value)] = index;
      });
      break;
    case 'range':
...
FilterService.prototype.setEnumOption = function(fieldKey, option, value) {
  ...
  field.options._data[field.options._enumMap[option]].enabled = value;
  return self._setField(field);
};
